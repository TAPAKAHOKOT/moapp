...
export function AnalyticsView({ userId, workspaceId, bootstrap, setBootstrap = () => {}, theme, online, timeZone = appTimeZone() }: { userId: string; workspaceId: string; bootstrap: Bootstrap; setBootstrap?: React.Dispatch<React.SetStateAction<Bootstrap>>; theme: Theme; online: boolean; timeZone?: string }) {
